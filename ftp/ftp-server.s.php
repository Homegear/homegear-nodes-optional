...
class HomegearNode extends HomegearNodeBase
{
    ...
    {
        $data = array('server' => $this->nodeInfo['info']['server'], 'port' => $this->nodeInfo['info']['port'], 'path' => $this->nodeInfo['info']['path'], 'username' => $this->nodeInfo['info']['user'], 'password' => $this->getNodeData('password'));
        return $data;
    }
